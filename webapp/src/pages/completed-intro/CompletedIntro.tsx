...
import TestExecutionAnimation, { DEFAULT_DELAY } from '../../components/ui/interface/test-execution-animation/TestExecutionAnimation';
...
export default class CompletedIntro extends Component<Props> {
